module.exports = app => {
    ...
    // View Design StatusEvaluasiPelimpahans
    app.options("/statusevaluasipelimpahan", statusevaluasipelimpahan.design);
    ...
    // Create a new StatusEvaluasiPelimpahan
    app.delete("/statusevaluasipelimpahan", statusevaluasipelimpahan.deleteAll);
};
